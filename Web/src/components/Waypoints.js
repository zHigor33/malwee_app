        ...
        <div className="body_popup">
            ...
            <div className="popup">
                ...
                <div className="field">
                    ...
                    <input className="field_coords" placeholder="Latitude" onChange={e => set_latitude(e.target.value)} />
                    <input className="field_coords" placeholder="Longitude" onChange={e => set_longitude(e.target.value)} />
